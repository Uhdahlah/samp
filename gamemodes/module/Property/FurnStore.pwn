...
CMD:editfurnstore(playerid, params[])
{
	...
	else if(!strcmp(opsi, "sell"))
	{
		...
		if(pData[storeData[id][storeOwner]][pOtherPropOwner1] == storeData[id][storeID])
		{
			pData[storeData[id][storeOwner]][pOtherPropOwner1] = -1;
		}
		else if(pData[storeData[id][storeOwner]][pOtherPropOwner2] == storeData[id][storeID])
		{
			pData[storeData[id][storeOwner]][pOtherPropOwner2] = -1;
		}
		else if(pData[storeData[id][storeOwner]][pOtherPropOwner3] == storeData[id][storeID])
		{
			pData[storeData[id][storeOwner]][pOtherPropOwner3] = -1;
		}

		storeData[id][storeVault] = storeData[id][storeOwner] = 0;
		storeData[id][storeEmploye][0] = storeData[id][storeEmploye][1] = storeData[id][storeEmploye][2] = 0;
		format(storeData[id][storeOwnerName], MAX_PLAYER_NAME, "-");
...
CMD:buyfurnstore(playerid, params[])
{
	...
	if((id = FurnStore_Nearest(playerid)) != -1)
	{
		...
		{
			pData[playerid][pOtherPropOwner1] = id;
		}
		else if(pData[playerid][pOtherPropOwner2] == -1)
		{
			pData[playerid][pOtherPropOwner2] = id;
		}
		else if(pData[playerid][pOtherPropOwner3] == -1)
		{
			pData[playerid][pOtherPropOwner3] = id;
		}
