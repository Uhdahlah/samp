...
{
	ShowPlayerDialog(playerid, DIALOG_HELP, DIALOG_STYLE_LIST, "Help Command Menu", "Player\nChat\nVehicle\nJob\nFaction\nFamily\nBisnis\nHouse\nFlat\nWorkshop\nFarm\nDonatur\nFurnStore", "Select", "Close");
	return 1;
}
...
CMD:credits(playerid)
{
	...
	strcat(line3, ""LB_E"Founder Server: "YELLOW_E"Gulu\n");
	strcat(line3, ""LB_E"Server Developer: "YELLOW_E"Diaz\n");
	strcat(line3, ""LB_E"Support Website: "YELLOW_E"-\n");
	format(line2, sizeof(line2), ""LB_E"Server Support: All SA-MP Team\n\n\
	"GREEN_E"Terima kasih telah bergabung dengan kami! Copyright © 2022 | AZRP 2022");
...
CMD:time(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_TABLIST_HEADERS, "Time Player", irwan, "Close", "");
	return 1;
}
...
CMD:settings(playerid)
{
	...
	if(pData[playerid][pHBEMode] == 0)
	{
		hbemode = "Hide";
	}
	else if(pData[playerid][pHBEMode] == 1)
	{
		hbemode = "Show";
	}
