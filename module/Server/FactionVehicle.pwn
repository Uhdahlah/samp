...
CreateVehicleFaction()
{
	...
	SetVehicleNumberPlate(LincolnMerah[1], ""GREEN_E"LINCON-1");
	...
	SetVehicleNumberPlate(LincolnMerah[2], ""GREEN_E"LINCON-2");
	...
	SetVehicleNumberPlate(LincolnMerah[3], ""GREEN_E"LINCON-3");
	...
	SetVehicleNumberPlate(LincolnMerah[4], ""GREEN_E"LINCON-4");
	...
	SetVehicleNumberPlate(LincolnMerah[5], ""GREEN_E"LINCON-5");
	SetVehicleHealth(LincolnMerah[5], 2000.0);
	AddVehicleComponent(LincolnMerah[5], 1080);
	//Lincoln Ungu Putih
	LincolnUngu[1] = LSPDVehicles[35] = AddStaticVehicleEx(596,1595.1029,-1711.1693,5.6132,358.1242,0,0, VEHICLE_RESPAWN); // Cruiser
	SetVehicleNumberPlate(LincolnUngu[1], ""GREEN_E"LINCON-6");
	SetVehicleHealth(LincolnUngu[1], 2000.0);
	AddVehicleComponent(LincolnUngu[1], 1074);
	LincolnUngu[2] = LSPDVehicles[36] = AddStaticVehicleEx(596,1591.2061,-1711.1152,5.6060,357.9518,0,0, VEHICLE_RESPAWN); // Cruiser
	SetVehicleNumberPlate(LincolnUngu[2], ""GREEN_E"LINCON-7");
	SetVehicleHealth(LincolnUngu[2], 2000.0);
	AddVehicleComponent(LincolnUngu[2], 1074);
	LincolnUngu[3] = LSPDVehicles[37] = AddStaticVehicleEx(596,1587.8042,-1711.0640,5.6139,0.4377,0,0, VEHICLE_RESPAWN); // Cruiser
	SetVehicleNumberPlate(LincolnUngu[3], ""GREEN_E"LINCON-8");
	SetVehicleHealth(LincolnUngu[3], 2000.0);
	AddVehicleComponent(LincolnUngu[3], 1074);
	LincolnUngu[4] = LSPDVehicles[38] = AddStaticVehicleEx(596,1583.5166,-1710.9095,5.6262,357.2809,0,0, VEHICLE_RESPAWN); // Cruiser
	SetVehicleNumberPlate(LincolnUngu[4], ""GREEN_E"LINCON-9");
