...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	if(dialogid == DIALOG_HELP)
    {
		...
		switch(listitem)
		{
			...
			case 7:
			{
				ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "House Help", "/buyhouse /lockhouse /myhouse /findhouse", "Ok", "Kembali");
			}
			case 8:
			{
				ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "Casino Help", "/buycasino /cdeposit /cwithdraw /dice /acceptdice", "Ok", "Kembali");
			}
			case 9:
			{
				ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "Workshop Help", "/buy /wsafe /winvite /wuninvite /winfo", "Ok", "Kembali");
			}
			case 10:
			{
				ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "Apart Help", "/buy /apsetsafe /apsafe /plock", "Ok", "Kembali");
			}
			case 11:
			{
				ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "Donatur Help", "/usegold /radio /usegold", "Ok", "Kembali");
			}
		}
		return 1;
	}
